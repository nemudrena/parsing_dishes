...
with open("info_test_salad_4.csv", mode="w", encoding='utf-8') as w_file:
...
with open("test_salad_3.csv", encoding='utf-8') as r_file:
...
with open("test_salad_4.csv", mode="w", encoding='utf-8') as w_file:
    file_writer = csv.writer(w_file, delimiter="\\", lineterminator="\r")
